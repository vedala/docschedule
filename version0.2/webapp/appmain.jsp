...
<body>
<h1>DocSchedule</h1>
<p>DocSchedule is an application for generating and viewing physician schedule. The application primary focus is scheduling for Hospitalist physician groups.</p>
